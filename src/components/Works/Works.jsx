      ...
      <div className="w-right">
        ...
        >
          <div className="w-secCircle">
            <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/android/android-original-wordmark.svg" alt=""  />
          </div>
          <div className="w-secCircle">
          ...
          <div className="w-secCircle">
            <img src="https://www.vectorlogo.zone/logos/springio/springio-icon.svg" alt="" />
          </div>
          <div className="w-secCircle">
